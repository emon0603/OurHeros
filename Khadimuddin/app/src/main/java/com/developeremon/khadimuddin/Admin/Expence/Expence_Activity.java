package com.developeremon.khadimuddin.Admin.Expence;
...
import com.developeremon.khadimuddin.Admin.notice.Notice_Write;
...
public class Expence_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        noticeadd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivity(new Intent(Expence_Activity.this, Notice_Write.class));
            }
        });
    }
        ...
        public View getView(int position, View view, ViewGroup parent) {
            ...
            listlay.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    startActivity(new Intent(Expence_Activity.this,Notice_Details_View.class));
                }
            });

            PopupMenu popupMenu = new PopupMenu(Expence_Activity.this, morebt);
            ...
            popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                ...
                public boolean onMenuItemClick(MenuItem menuItem) {
                    ...
                    if (menuItem.getItemId() == R.id.editbt){
                        ...
                        new AlertDialog.Builder(Expence_Activity.this)
                                .setTitle("Alert ")
    ...
    private void JsonarrayRequet(){
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(Request.Method.POST, url, jsonArray, new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response) {
                ...
                //----------------------------------------------------------------
                if (arrayList.size() > 0 ){
                    ExpenceAdapter ExpenceAdapter = new ExpenceAdapter();
                    noticelist.setAdapter(ExpenceAdapter);
                }
                //----------------------------------------------------------------
        ...
        StringRequest deleterequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if (response.contains("Data Delete Successful")){
                    Toast.makeText(Expence_Activity.this, response, Toast.LENGTH_SHORT).show();
                    //JsonarrayRequet();
                    onResume();
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(Expence_Activity.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        }){
